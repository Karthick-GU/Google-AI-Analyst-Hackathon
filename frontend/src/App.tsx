      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/project/:projectId/hypotheses" element={<HypothesesDashboard />} />
            <Route path="/project/:projectId/experiments" element={<ExperimentSuggestion />} />
            <Route path="/project/:projectId/test-cards" element={<TestCard />} />
            <Route path="/project/:projectId/learning-card" element={<LearningCard />} />
